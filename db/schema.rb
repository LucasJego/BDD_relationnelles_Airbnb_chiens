...
ActiveRecord::Schema.define(version: 2019_10_24_182108) do
  ...
  create_table "join_talbe_dog_strolls", force: :cascade do |t|
    t.integer "stroll_id"
    t.integer "dog_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["dog_id"], name: "index_join_talbe_dog_strolls_on_dog_id"
    t.index ["stroll_id"], name: "index_join_talbe_dog_strolls_on_stroll_id"
  end
